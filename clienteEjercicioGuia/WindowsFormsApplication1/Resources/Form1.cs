...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
                    ...
                    case 9:
                        ...
                        else 
                        {
                            Invoke(new Action(() =>
                            {
                                ...
                                Enviados.Rows.Clear();
                                Desconectar.Visible = false;
                                ChatLbl.Text = "Las personas que estan en este chat son: " + Host.Text + "  " + Nick1.Text + "  " + Nick2.Text + "  " + Nick3.Text;
                            }));
        ...
        private void Recibidos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
